...
public class Operations {
    ...
    public static Vector4 multiply(Matrix4 m, Vector4 v) {
        ...
        return vector4.scale(vector4.getW() != 0.0d ? 1.0d / vector4.getW() : 1);
    }
    ...
    public static Matrix4 multiply(Matrix4 m1, Matrix4 m2, Matrix4 m3) {

        return multiply(multiply(m1, m2), m3);
    }

    public static Matrix4 multiply(Matrix4 m1, Matrix4 m2, Matrix4 m3, Matrix4 m4) {

        return multiply(multiply(multiply(m1, m2), m3), m4);
    }

    public static Matrix4 multiply(Matrix4 m1, Matrix4 m2, Matrix4 m3, Matrix4 m4, Matrix4 m5) {
